...
require (
	...
	github.com/cilium/proxy v0.0.0-20190904224335-feb9a25e4689
...
replace (
	...
	github.com/aws/aws-sdk-go-v2 => github.com/aws/aws-sdk-go-v2 v0.12.0
	...
	github.com/cilium/proxy => github.com/cilium/proxy v0.0.0-20190904224335-feb9a25e4689
	...
	github.com/containerd/containerd => github.com/containerd/containerd v1.2.9
	...
	github.com/hashicorp/serf => github.com/hashicorp/serf v0.8.4
	...
	github.com/shirou/gopsutil => github.com/shirou/gopsutil v2.18.12+incompatible
	...
	go.mongodb.org/mongo-driver => go.mongodb.org/mongo-driver v1.1.1
	...
	golang.org/x/net => golang.org/x/net v0.0.0-20190923162816-aa69164e4478
	...
	golang.org/x/sys => golang.org/x/sys v0.0.0-20190924154521-2837fb4f24fe
	golang.org/x/text => golang.org/x/text v0.3.2
	golang.org/x/time => golang.org/x/time v0.0.0-20190921001708-c4c64cad1fd0
	golang.org/x/tools => golang.org/x/tools v0.0.0-20190907020128-2ca718005c18
	...
	google.golang.org/appengine => google.golang.org/appengine v1.6.3
	...
	// v0.0.0-20190913145653-2bd9643cee5b -> k8s v1.16.0
	...
	k8s.io/client-go => github.com/cilium/client-go v0.0.0-20190918190922-1eab0199a695
